...
import { updateSearch, viewDetailsFetch } from '../Redux/Action';
function Video() {
    ...
    useEffect(() => {
        ...
        dispatch(updateSearch(setsearch));
    }, [id, setsearch])
    // if (setsearch != "New") {
    ...
    return (
        ...
        <Box display={{ base: "block", md: "flex", lg: "flex" }} ml={'30px'} pt={{ base: "35px", md: "75px", md: "75px" }} w={'100%'} m='auto' justifyContent={'space-evenly'}>
            <Box width={{ base: "100%", md: "100%", lg: "65%" }} position={{ base: "fixed", md: "static", lg: "sticky" }} height={{ base: "250px", md: "500px", lg: "500px" }} >
            ...
            <Box pt={{ base: "340px", md: "0px", lg: "0px" }} overflow='scroll' h='100vh' width={{ base: "100%", md: "25%", lg: "25%" }} className='rec_parent' display={{ base: 'block', md: 'none', lg: 'block' }} >
                <Recomendation />
